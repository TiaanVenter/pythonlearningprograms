...
if formula == 'c':
    ...
    #comment to change hash(?). This was stolen from somewhere. My apologies for not crediting, but a simple google search for 'Python Pythagoras' shouldd bring you to the same program.